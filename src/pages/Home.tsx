	...
	return (
		<div className="relative isolate overflow-hidden bg-gradient-to-b from-gray-100/20 dark:from-gray-900/20">
			<div className="mx-auto max-w-7xl py-24 lg:grid lg:grid-cols-2 lg:gap-x-8 sm:px-8">
				<Reveal className="px-6 lg:px-0" delay={80}>
					<div className="mx-auto max-w-2xl">
						<div className="max-w-lg">
							<Reveal className="flex items-center gap-3" delay={140}>
							...
							<Reveal className="mt-10 flex items-center gap-x-6" delay={300}>
								<a
									href={resumeHref}
									target="_blank"
									rel="noopener noreferrer"
									className="rounded-md bg-violet-600 dark:bg-violet-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-violet-500 dark:hover:bg-violet-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-violet-500/20"
								>
									{t("downloadResume")}
								</a>
								<a
									...
									target="_blank"
									rel="noopener noreferrer"
									className="text-sm/6 font-semibold text-gray-900 dark:text-gray-300 hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-300"
								>
									{t("viewGithub")}
								</a>
							</Reveal>
				...
				<Reveal
					className="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen relative"
					delay={180}
				>
					<div className="relative h-full w-full overflow-hidden rounded-sm">
						<img
							src={samuelHome}
							className="w-full h-[760px] object-cover object-center scale-105 lg:scale-110 transform-gpu transition-transform duration-700 ease-out hover:scale-[1.03]"
							alt={t("imageAlt")}
						/>
